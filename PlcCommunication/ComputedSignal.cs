...
namespace PlcCommunication
{
    public class ComputedSignal : IOSignal
    {
        ...
        public ComputedSignal(
            ...
            string Description,
            string PlcName = "")
            : base(0, Name, true, TYPE.INPUT_REGISTER, "", "", Description, "", "", PlcName)
        {
        ...
        {
            this.UpdateValueOnlyNoDisplay();
            base.DisplayIsConnected = true;
        }

        public void UpdateValueOnlyNoDisplay()
        {
                ...
                case COMPUTATION_TYPE.ANALOG_SENSOR:
                    {
                        ...
                        if (SourceSignals[0].BitCount==16 && sensor_reading >= 0x8000)
                        {
                            unchecked
                            {
