...
public class Scanner {
	...
	static {
		...
		literals.put("True", new Integer(14));
		literals.put("False", new Integer(15));
		literals.put("NotConnected", new Integer(16));
		literals.put("Signal", new Integer(17));
		literals.put("IsConnected", new Integer(18));
		literals.put("Not", new Integer(19));
		literals.put("And", new Integer(20));
		literals.put("Or", new Integer(21));
		literals.put("Xor", new Integer(22));
