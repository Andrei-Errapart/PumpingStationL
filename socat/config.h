...
#define HAVE_BASIC_SIZE_T 4 /* unsigned long */
#define HAVE_BASIC_MODE_T 2 /* unsigned int */
#define HAVE_BASIC_PID_T 3 /* int */
#define HAVE_BASIC_UID_T 4 /* unsigned int */
#define HAVE_BASIC_GID_T 4 /* unsigned int */
#define HAVE_BASIC_TIME_T 3 /* long */
#define HAVE_BASIC_OFF_T 3 /* long */
#define HAVE_BASIC_OFF64_T 5 /* long */

#define HAVE_BASIC_SOCKLEN_T 4 /* unsigned int */

#define HAVE_TYPEOF_ST_DEV 4 /* unsigned long */
#define HAVE_TYPEOF_ST_INO 4 /* unsigned long */
#define HAVE_TYPEOF_ST_NLINK 4 /* unsigned long */
#define HAVE_TYPEOF_ST_SIZE 3 /* long */
#define HAVE_TYPEOF_ST_BLKSIZE 3 /* long */
#define HAVE_TYPEOF_ST_BLOCKS 3 /* long */
